        ...
        foreach($results as $result)
        {
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="update.php?imageid=<?php echo ($result->id) ?>" class="btn btn-success">Update</a>
              <a href="delete.php?imageid=<?php echo ($result->id) ?>" class="btn btn-danger">Delete</a></td>
          </tr>
          <?php
          $cnt=$cnt+1;
        }
